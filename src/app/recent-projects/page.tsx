      ...
      <section className="mx-auto p-6 mt-12 md:mt-16 max-w-7xl bg-gradient-to-b from-white to-gray-100 shadow-lg rounded-xl">
        ...
        <div className="mt-8 flex flex-col items-center gap-12">
          {selectedProjects.map((project, index) => (
            ...
            >
              ...
              <p className="text-gray-500 text-center mt-2 text-md italic">{project.address}</p>
        ...
        <div className="flex justify-between items-center mt-12">
          <button
            ...
            className={`px-6 py-3 rounded-full transition-all duration-300 text-lg font-medium shadow-md ${currentPage === 1 ? "bg-gray-300 cursor-not-allowed" : "bg-green-600 text-white hover:bg-green-700"}`}
          >
            Previous
          </button>
          ...
          <button
            ...
            className={`px-6 py-3 rounded-full transition-all duration-300 text-lg font-medium shadow-md ${currentPage === totalPages ? "bg-gray-300 cursor-not-allowed" : "bg-green-600 text-white hover:bg-green-700"}`}
          >
            Next
          </button>
        </div>
